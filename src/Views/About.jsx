            ...
            <div>
              ...
              <p className="subtitle">
                <span className="black-color" style={{ fontWeight: "bold" }}>
                  ...
                  海外学生团契！我们是一个温暖友好的社区，致力于为来自世界各地的国际学生提供支持、友谊和有意义的体验。在这里，您将有机会与不同文化背景的人们互动，建立深厚的友谊，分享经历，并且一同探索美国的文化。
                  海外学生团契不仅能让您建立友谊，还为您提供参与各种有趣活动的机会，包括文化交流、社交聚会、志愿者服务以及精神层面的活动。我们追求着一个共同目标，即在异国他乡度过难忘的学术和生活时光。
                </span>
              </p>
              <br></br>
              <p className="subtitle">
            ...
            <Row>
              <Col lg={3} md={3} sm={6} xs={12} className="mb-lg-0 mb-4">
                ...
                <div style={{ marginLeft: 30, marginRight: 30 }}>
                  <p>每周五晚上我们都会有免费的晚餐活动，欢迎大家来交朋友！</p>
                </div>
              </Col>
