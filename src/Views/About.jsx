            ...
            <div>
              ...
              <p className="subtitle">
                <span className="black-color" style={{ fontWeight: "bold" }}>
                  ...
                  海外学生团契！我们是一个温暖友好的社团团契，致力于为来自世界各地的国际学生提供支持、友谊和有意义的活动。在这里，你将有机会与不同文化背景的人们互动，建立深厚的友谊，分享经历，并且一同探索美国的文化。
                  海外学生团契不仅能让你建立友谊，还为您提供参与各种有趣的活动，包括文化交流、社交聚会、志愿者服务以及精神层面的关怀。我们希望榜值你在异国他乡度过难忘的学术和生活时光。
                </span>
              </p>
              <br></br>
              <p className="subtitle">
